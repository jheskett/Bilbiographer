...
'
' This is a Partial class of MainForm and contains the code for the UpdatePanel in a separate file. It is not a distinct
' class but merely UpdatePanel-related code split from MainForm.vb into a separate file so the code is better organized.
'
